...
<script>
	...
	let initForm = { title: '', body: '', userId: 1 };
...
<div class="flex w-full items-center justify-center">
	<div class="w-[500px] rounded-lg bg-white p-10 shadow-lg">
		<div class="mb-10 flex w-full flex-wrap items-center gap-5 max-md:max-w-full">
			<div
				class="my-auto flex min-w-[240px] flex-1 shrink basis-0 flex-wrap items-center gap-5 self-stretch max-md:max-w-full"
			>
				<div
					class="relative flex h-[70px] min-h-[70px] w-[70px] flex-col justify-center self-stretch overflow-hidden rounded-[16px] bg-gray-100"
				>
					<div class="aspect-auto h-[100px] w-[100px]">
						<svg
				...
				<div class="my-auto flex min-w-[240px] flex-col self-stretch">
					<div class="text-base text-gray-800">Antony P.Johnson</div>
					<div class="mt-2 text-sm text-gray-500">UX/UI designer, in Company Name Ltd.</div>
				</div>
			</div>
		</div>
		...
		<div class="mb-10 grid grid-cols-1 gap-6">
			<div id="input" class="relative">
				<input
					type="text"
					id="Title"
					class="hover:border-brand-500-secondary- peer invalid:border-error-500 invalid:focus:border-error-500 block h-[50px] w-full appearance-none overflow-hidden rounded-[8px] border border-violet-200 bg-white px-4 pr-[48px] text-sm text-nowrap overflow-ellipsis text-slate-900 focus:border-transparent focus:ring-0 focus:outline focus:outline-2 focus:outline-primary"
					placeholder="Title"
			...
			<div id="input" class="relative">
				<textarea
					id="Body"
					class="hover:border-brand-500-secondary- peer invalid:border-error-500 invalid:focus:border-error-500 block h-[50px] min-h-[100px] w-full appearance-none overflow-hidden rounded-[8px] border border-violet-200 bg-white px-4 pt-2 pr-[48px] text-sm text-nowrap overflow-ellipsis text-slate-900 focus:border-transparent focus:ring-0 focus:outline focus:outline-2 focus:outline-primary"
					placeholder="Body"
		...
		<div class="flex gap-4 sm:flex sm:flex-row-reverse">
			<button
				...
				on:click={handleSave}
			>
				<div class="flex items-center gap-2">{loading ? 'Saving...' : 'Save changes'}</div>
			</button>
			<button
